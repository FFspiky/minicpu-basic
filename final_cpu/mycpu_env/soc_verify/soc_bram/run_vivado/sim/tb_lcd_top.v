...
module tb_lcd_top;
    localparam [31:0] LCD_SIM_END_PC = 32'h1c000100;
    ...
    begin
        ...
        timeout = 0;
        while (dut.u_soc.debug_wb_pc != LCD_SIM_END_PC && timeout < 100000)
        begin
            #10;
            timeout = timeout + 1;
        end
        if (timeout >= 100000)
        begin
            $display("FAIL: continuous LCD smoke test did not reach END_PC");
        ...
        $display("PASS: BRAM pipeline LCD continuous smoke test completed");
        #100;
        $finish;
    end
