...
set project_file [file join $project_dir final_cpu_lcd.xpr]
...
if {[file exists $project_file]} {
    ...
    create_project final_cpu_lcd $project_dir -part xc7a200tfbg676-1
}
...
set lcd_dcp [file normalize [file join $script_dir ../lib/lcd_module_cell.dcp]]
